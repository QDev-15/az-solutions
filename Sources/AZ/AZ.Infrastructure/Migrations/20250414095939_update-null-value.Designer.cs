...
namespace AZ.Infrastructure.Migrations
{
    ...
    [Migration("20250414095939_update-null-value")]
            ...
            modelBuilder.Entity("AZ.Infrastructure.Entities.Feedback", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2025, 4, 14, 9, 59, 39, 339, DateTimeKind.Utc).AddTicks(670));
            ...
            modelBuilder.Entity("AZ.Infrastructure.Entities.Like", b =>
                {
                    ...
                    b.Property<DateTime>("LikedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2025, 4, 14, 9, 59, 39, 339, DateTimeKind.Utc).AddTicks(1534));
            ...
            modelBuilder.Entity("AZ.Infrastructure.Entities.Log", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2025, 4, 14, 9, 59, 39, 339, DateTimeKind.Utc).AddTicks(3090));
            ...
            modelBuilder.Entity("AZ.Infrastructure.Entities.Media", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2025, 4, 14, 9, 59, 39, 339, DateTimeKind.Utc).AddTicks(4015));
                    ...
                    b.Property<DateTime>("UpdatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2025, 4, 14, 9, 59, 39, 339, DateTimeKind.Utc).AddTicks(4174));
            ...
            modelBuilder.Entity("AZ.Infrastructure.Entities.User", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2025, 4, 14, 9, 59, 39, 340, DateTimeKind.Utc).AddTicks(378));
                    ...
                    b.Property<DateTime>("UpdatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2025, 4, 14, 9, 59, 39, 340, DateTimeKind.Utc).AddTicks(612));
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2025, 4, 14, 9, 59, 39, 341, DateTimeKind.Utc).AddTicks(8467),
                            DisplayName = "",
                            Email = "nguyenquynhvp.ictu@gmail.com",
                            FirstName = "",
                            LastName = "",
                            PasswordHash = "AQAAAAIAAYagAAAAELxu8ftVZd9XTJkIYtyJz84GF72JdOrs7Lwde4O41l3AXetudnGrZ0jlrMDCNpUTYQ==",
                            PhoneNumber = "0988632841",
                            Status = "Active",
                            UpdatedAt = new DateTime(2025, 4, 14, 9, 59, 39, 341, DateTimeKind.Utc).AddTicks(8468),
                            Username = "sysadmin"
                        });
                });
