            ...
            modelBuilder.Entity("AZ.Infrastructure.Entities.Feedback", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2025, 4, 9, 9, 40, 44, 995, DateTimeKind.Utc).AddTicks(8194));
            ...
            modelBuilder.Entity("AZ.Infrastructure.Entities.Like", b =>
                {
                    ...
                    b.Property<DateTime>("LikedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2025, 4, 9, 9, 40, 44, 995, DateTimeKind.Utc).AddTicks(9265));
            ...
            modelBuilder.Entity("AZ.Infrastructure.Entities.Log", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2025, 4, 9, 9, 40, 44, 996, DateTimeKind.Utc).AddTicks(1162));
            ...
            modelBuilder.Entity("AZ.Infrastructure.Entities.Media", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2025, 4, 9, 9, 40, 44, 996, DateTimeKind.Utc).AddTicks(2099));
                    ...
                    b.Property<DateTime>("UpdatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2025, 4, 9, 9, 40, 44, 996, DateTimeKind.Utc).AddTicks(2261));
            ...
            modelBuilder.Entity("AZ.Infrastructure.Entities.User", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2025, 4, 9, 9, 40, 44, 996, DateTimeKind.Utc).AddTicks(8068));
                    ...
                    b.Property<DateTime>("UpdatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2025, 4, 9, 9, 40, 44, 996, DateTimeKind.Utc).AddTicks(8271));
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2025, 4, 9, 9, 40, 44, 998, DateTimeKind.Utc).AddTicks(261),
                            DisplayName = "",
                            Email = "nguyenquynhvp.ictu@gmail.com",
                            FirstName = "",
                            LastName = "",
                            PasswordHash = "AQAAAAIAAYagAAAAEE1VBJ6fEiXW14VDLUQVI7FWM2l8vc2stz5eyKXPOgQuBPEJFyZS1V2mczjiwZ1fGg==",
                            PhoneNumber = "0988632841",
                            Status = "Active",
                            UpdatedAt = new DateTime(2025, 4, 9, 9, 40, 44, 998, DateTimeKind.Utc).AddTicks(267),
                            Username = "sysadmin"
                        });
                });
