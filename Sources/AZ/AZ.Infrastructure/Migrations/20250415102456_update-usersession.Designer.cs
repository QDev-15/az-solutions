...
namespace AZ.Infrastructure.Migrations
{
    ...
    [Migration("20250415102456_update-usersession")]
            ...
            modelBuilder.Entity("AZ.Infrastructure.Entities.Feedback", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2025, 4, 15, 10, 24, 55, 570, DateTimeKind.Utc).AddTicks(9951));
            ...
            modelBuilder.Entity("AZ.Infrastructure.Entities.Like", b =>
                {
                    ...
                    b.Property<DateTime>("LikedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2025, 4, 15, 10, 24, 55, 571, DateTimeKind.Utc).AddTicks(2118));
            ...
            modelBuilder.Entity("AZ.Infrastructure.Entities.Log", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2025, 4, 15, 10, 24, 55, 571, DateTimeKind.Utc).AddTicks(4491));
            ...
            modelBuilder.Entity("AZ.Infrastructure.Entities.Media", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2025, 4, 15, 10, 24, 55, 571, DateTimeKind.Utc).AddTicks(5372));
                    ...
                    b.Property<DateTime>("UpdatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2025, 4, 15, 10, 24, 55, 571, DateTimeKind.Utc).AddTicks(5536));
            ...
            modelBuilder.Entity("AZ.Infrastructure.Entities.User", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2025, 4, 15, 10, 24, 55, 572, DateTimeKind.Utc).AddTicks(314));
                    ...
                    b.Property<DateTime>("UpdatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2025, 4, 15, 10, 24, 55, 572, DateTimeKind.Utc).AddTicks(515));
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2025, 4, 15, 10, 24, 55, 573, DateTimeKind.Utc).AddTicks(438),
                            DisplayName = "",
                            Email = "nguyenquynhvp.ictu@gmail.com",
                            FirstName = "",
                            LastName = "",
                            PasswordHash = "AQAAAAIAAYagAAAAEPk1e9GxRQRFtKeF5U41/ASGdRei11RvpUlQUwHCjGO2G5lXxl2k6bZMpRZzDLFAYA==",
                            PhoneNumber = "0988632841",
                            Status = "Active",
                            UpdatedAt = new DateTime(2025, 4, 15, 10, 24, 55, 573, DateTimeKind.Utc).AddTicks(440),
                            Username = "sysadmin"
                        });
                });
